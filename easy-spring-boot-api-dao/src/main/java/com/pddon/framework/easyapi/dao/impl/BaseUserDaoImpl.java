...
public abstract class BaseUserDaoImpl<T extends BaseUserMapper<K>, K extends BaseUser> extends ServiceImpl<T, K> implements BaseUserDao<K> {
    ...
    public IPage<K> pageQuery(UserListRequest req) {
        ...
        Wrapper<K> wrapper = new LambdaQueryWrapper<K>()
                ...
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.USER_ID.equals(req.getType()), BaseUser::getUserId, req.getKeyword())
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.USERNAME.equals(req.getType()), BaseUser::getUsername, req.getKeyword())
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.NICKNAME.equals(req.getType()), BaseUser::getNickname, req.getKeyword())
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.EMAIL.equals(req.getType()), BaseUser::getEmail, req.getKeyword())
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.PHONE.equals(req.getType()), BaseUser::getPhone, req.getKeyword())
                .likeLeft(!StringUtils.isEmpty(req.getKeyword()) && UserKeyType.INTRO.equals(req.getType()), BaseUser::getIntro, req.getKeyword())
