/**  
* Title SystemParameterRenameManager.java
* Description  系统参数名管理
* @author danyuan
* @date Oct 18, 2020
* @version 1.0.0
...
public class SystemParameterRenameManager {
	protected static final Map<String, String> DEFAULT_PARAM_MAP = new HashMap<>();
	...
	static {//允许自定义系统参数名
		...
		DEFAULT_PARAM_MAP.put(COUNTRY_CODE, COUNTRY_CODE);
		DEFAULT_PARAM_MAP.put(TIME_ZONE, TIME_ZONE);
		DEFAULT_PARAM_MAP.put(SESSION_ID, SESSION_ID);
		DEFAULT_PARAM_MAP.put(USER_ID, USER_ID);
		DEFAULT_PARAM_MAP.put(SIGN, SIGN);
		DEFAULT_PARAM_MAP.put(CHANNEL_ID, CHANNEL_ID);
		DEFAULT_PARAM_MAP.put(VERSION_CODE, VERSION_CODE);
		DEFAULT_PARAM_MAP.put(REPEAT_CODE, REPEAT_CODE);
		DEFAULT_PARAM_MAP.put(TIMESTAMP, TIMESTAMP);
		DEFAULT_PARAM_MAP.put(CLIENT_ID, CLIENT_ID);
		DEFAULT_PARAM_MAP.put(CLIENT_IP, CLIENT_IP);
	}
