/**  
 * Title MethodDistributedLockPointcutAdvisor.java
 * Description  
 * @author danyuan
 * @date Dec 17, 2023
 * @version 1.0.0
...
import com.pddon.framework.easyapi.interceptor.MethodDistributedLockInterceptorManager;
...
@Component
public class MethodDistributedLockPointcutAdvisor extends
StaticMethodMatcherPointcutAdvisor implements InitializingBean {
	
	@Autowired
	@Lazy
	private MethodDistributedLockInterceptorManager methodDistributedLockInterceptorManager;
	...
	public void afterPropertiesSet() throws Exception {
		this.setAdvice(methodDistributedLockInterceptorManager);
