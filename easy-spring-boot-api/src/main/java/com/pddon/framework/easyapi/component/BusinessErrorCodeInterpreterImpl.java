/**  
* Title BusinessErrorCodeInterpreterImpl.java
* Description  错误码工具包
* @author danyuan
* @date Nov 8, 2019
* @version 1.0.0
...
@Service
@Slf4j
public class BusinessErrorCodeInterpreterImpl implements BusinessErrorCodeInterpreter{
	...
	@Override
	public Integer getCode(String error){
